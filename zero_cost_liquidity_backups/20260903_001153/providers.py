...
class ProviderHub:
    ...
    async def snapshot(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # FOREXCOM_CHART_LIQUIDITY_SYNC_V1
            # Exact TradingView FOREXCOM:NAS100 chart levels become primary.
            from .forexcom_chart_liquidity import apply_forexcom_chart_liquidity
            await apply_forexcom_chart_liquidity(self, data)
        except Exception as e:
            data["nq_liquidity"] = {
                "instrument": "NQ",

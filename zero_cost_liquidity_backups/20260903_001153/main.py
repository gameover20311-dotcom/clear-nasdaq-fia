...
# FOREXCOM_CHART_LIQUIDITY_SYNC_ROUTES_V1
from fia.forexcom_chart_liquidity_api import install_forexcom_chart_liquidity_routes
install_forexcom_chart_liquidity_routes(app)

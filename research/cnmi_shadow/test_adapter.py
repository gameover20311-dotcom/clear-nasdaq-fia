    ...
    def test_contaminated_materiality_is_rejected(self):
        ...
        c["claims"] = [{
            ...
            "materiality_identity": {
                "estimand": "x", "target_population": "p", "eligibility_rule": "g",
                "outcome_transform": "identity", "horizon": "8h", "aggregation_rule": "mean",
                "canonical_units": "unit", "margin": 1.0, "provenance_class": "DEVELOPMENT_INFORMED",
                "provenance_evidence": "documented", "freeze_identity": "v1",

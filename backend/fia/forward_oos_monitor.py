...
def build_campaign_status(root: Path | str = DEFAULT_ROOT) -> Dict[str, Any]:
    try:
        ...
        checks = {
            ...
            "ledger_integrity": bool(ledger.get("ok")),
            "campaign_seal": bool(seal.get("ok")),
            "report_integrity": bool(report.get("ok")),
        ...
        return {
            ...
            "resolved_4h_n": resolved["4h"],
            "resolved_8h_n": resolved["8h"],
            ...
            "tamper_evident": ledger.get("tamper_evident"),
            "durability": storage,
            ...
            "metrics_withheld_reason": (
                ...
                "INTEGRITY_OR_SEAL_FAILURE: stored records are not verified evidence."
                if not valid else

...
def evidence_alignment(forecast: Any) -> Dict[str, Any]:
    ...
    for signal in signals:
        ...
        # SOL56_NQ_IMPACT_SEMANTICS_V1
        # Every score entering the FIA forecast is already expressed as an
        # NQ-impact score. In particular provider_reliability.dxy_signal()
        # converts rising DXY to a NEGATIVE NQ score, and us10y_signal()
        # converts high yields to a NEGATIVE NQ score. Calling
        # nasdaq_impact_direction() here inverted DXY/US10Y a second time and
        # corrupted the evidence-agreement audit. Alignment must therefore use
        # the score sign directly.
        impact_direction = raw_direction.upper()

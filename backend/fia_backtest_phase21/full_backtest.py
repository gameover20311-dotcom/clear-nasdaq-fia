...
from fia_backtest_phase21.full_engine import build_forecast
...
OUTDIR = Path("fia_backtest_phase21/results")
CSV_PATH = OUTDIR / "phase21_no_neutral_backtest_1y.csv"
JSON_PATH = OUTDIR / "phase21_no_neutral_backtest_1y_summary.json"

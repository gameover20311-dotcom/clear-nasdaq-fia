...
class ProviderHub:
    ...
    def session_window_for_date(
        ...
        """
        Session definitions in New York time.

        Asia:
          20:00 previous day -> 00:00
        ...
        These are practical liquidity-session windows rather
        than exchange-specific settlement definitions.
        """
    ...
    async def get_session_liquidity(self, symbol: str = "QQQ"):
        """
        Calculates Asia/London/New York highs and lows from
        five-minute candles.

        Uses the most recent several calendar days so that
        completed sessions are available even when the current
        ...
        # Check the latest 7 calendar dates.
        for days_back in range(0, 8):
            ...
            for session in [
                ...
                # Keep the most recent completed/available session.
            ...
            # Once all three sessions have been found,

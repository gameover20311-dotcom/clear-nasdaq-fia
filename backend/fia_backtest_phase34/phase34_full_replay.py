...
from fia.artifact_guard import guarded_output_path  # A6 sealed-artifact guard
...
def main():
    ...
    _out=guarded_output_path(OUT); _out.parent.mkdir(parents=True,exist_ok=True); _out.write_text(json.dumps(result,indent=2)); print(json.dumps(result,indent=2))

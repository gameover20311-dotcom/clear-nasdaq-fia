...
async def build_snapshot_cached(target, hub, news_pool, earnings_pool):
    ...
    earnings = score_earnings_asof(target, hub, earnings_pool)
...
async def main():
    ...
    print("Prefetching earnings once...")
    earnings_pool = await prefetch_earnings_pool(hub, START, END)
